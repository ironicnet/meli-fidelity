 ...
 */
 ...
 require_once(dirname(__FILE__).'/../../vendor/symfony/lib/task/generator/sfGeneratorBaseTask.class.php');
 ...
 */
class sfGenerateAppCustomTask extends sfGeneratorBaseTask
{
  /**
   * @see sfTask
   */
  protected function configure()
  {
    ...
    $this->addOptions(array(
      ...
      new sfCommandOption('skeleton', null, sfCommandOption::PARAMETER_OPTIONAL, 'Custom skeleton', 'app')
    ));

    $this->namespace = 'generate';
    $this->name = 'app-custom';
...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    if (is_readable(sfConfig::get('sf_data_dir').'/skeleton/' . $options['skeleton']))
    {
       $skeletonDir = sfConfig::get('sf_data_dir').'/skeleton/' . $options['skeleton'];
    }
    else
    {
       $skeletonDir = dirname(__FILE__).'/skeleton/' . $options['skeleton'];
    }
