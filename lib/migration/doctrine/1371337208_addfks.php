...
class Addfks extends Doctrine_Migration_Base
{
    public function up()
    {
        $this->createForeignKey('ly_media_asset', 'ly_media_asset_folder_id_ly_media_folder_id', array(
             'name' => 'ly_media_asset_folder_id_ly_media_folder_id',
             'local' => 'folder_id',
             'foreign' => 'id',
             'foreignTable' => 'ly_media_folder',
             'onUpdate' => NULL,
             'onDelete' => 'CASCADE',
             ));
    ...
    {
        $this->dropForeignKey('ly_media_asset', 'ly_media_asset_folder_id_ly_media_folder_id');
