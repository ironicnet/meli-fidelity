...
class sfGDAdapter
{
  ...
  public function loadFile($thumbnail, $image)
  {
    ...
    if (in_array($imgData['mime'], $this->imgTypes))
    {
      ...
      {
        imagecopyresampled($this->thumb, $this->source,0, 0, $thumbnail->getSourceX(), $thumbnail->getSourceY(), $thumbnail->getThumbWidth(), $thumbnail->getThumbHeight(), $thumbnail->getSourceWidth(), $thumbnail->getSourceHeight()); 
      }
