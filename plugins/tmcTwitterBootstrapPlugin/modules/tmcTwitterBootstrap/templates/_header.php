      ...
      <div class="container-fluid">
         ...
         <div class="nav-collapse">
            <ul class="nav">
               ...
               <li class="<?php echo $is_current_route || $is_current_module ? 'active' : '' ?>"><a href="<?php echo url_for('@' . $route); ?>"><i class="<?php echo $icon; ?> icon-white"></i> <?php echo __($name) ?></a></li>
               <?php else: ?>
               <?php $submenus = $menu['dropdown']; ?>
               <?php $icon = $menu['icon']; ?>
               <li class="dropdown <?php echo $is_current_route || $is_current_module ? 'active' : '' ?>">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="<?php echo $icon; ?> icon-white"></i> <?php echo __($k) ?> <b class="caret"></b></a>
            ...
            <ul class="nav pull-right">
               <li class="dropdown">
               <a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="icon-user icon-white"></i> <?php echo $sf_user->getGuardUser() ?> <b class="caret"></b></a>
               <ul class="dropdown-menu">
                  <li><a href="<?php echo url_for("@my_account"); ?>"><i class="icon-pencil"></i> Editar cuenta</a></li>
                  <li class="divider"></li>
                  <li>
                  <a href="<?php echo url_for('@sf_guard_signout') ?>"><i class="icon-arrow-right"></i> Salir</a></li>
                  </li>
               </ul>
               </li>
            </ul>
