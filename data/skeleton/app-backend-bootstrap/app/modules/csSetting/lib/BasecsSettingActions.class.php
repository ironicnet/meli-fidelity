  ...
  public function executeListSaveSettings(sfWebRequest $request)
  {
    ...
    if($settings = $request->getParameter('cs_setting'))
    {
      ...
      if ($this->form->isValid()) 
      {
       ...
       // Clear cache
       csSettings::clearCache(sfConfig::get("app_csSettingsPlugin_frontend_app", "frontend"), "dev");
       csSettings::clearCache(sfConfig::get("app_csSettingsPlugin_frontend_app", "frontend"), "prod");
